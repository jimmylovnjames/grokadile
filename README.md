...
12. **ScreenActAgent (observe → decide → act loop)** — ✅ LANDED (0.3.3)
...
ScreenTap, **ScreenSummary**, **ScreenWait**, **ScreenAct**, Scheduler, NotificationListener, Swarm, VectorMemory, **Planner**,
